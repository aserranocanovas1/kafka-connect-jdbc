...
import io.confluent.connect.kerberos.jdbc.util.ConnectionProvider;
 ...
 * file a 
 * {@code META-INF/services/io.confluent.connect.kerberos.jdbc.dialect.DatabaseDialectProvider} 
 * file that contains the fully-qualified name of your implementation class (or one class per 
 * line if providing multiple implementations).
 *
