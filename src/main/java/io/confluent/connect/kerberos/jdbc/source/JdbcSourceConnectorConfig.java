...
package io.confluent.connect.kerberos.jdbc.source;
...
import io.confluent.connect.kerberos.jdbc.util.DatabaseDialectRecommender;
import io.confluent.connect.kerberos.jdbc.util.EnumRecommender;
import io.confluent.connect.kerberos.jdbc.util.QuoteMethod;
import io.confluent.connect.kerberos.jdbc.util.TimeZoneValidator;
...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static final String CONNECTION_KERBEROS_CONFIG = CONNECTION_PREFIX + "kerberos";
  private static final String CONNECTION_KERBEROS_DOC = "Kerberos file location (krb5.conf).";
  private static final String CONNECTION_KERBEROS_DISPLAY = "Kerberos file location";
  
  public static final String CONNECTION_JAAS_CONFIG = CONNECTION_PREFIX + "jaas";
  private static final String CONNECTION_JAAS_DOC 
      = "Kerberos JAAS file location (jaas_client.conf).";
  private static final String CONNECTION_JAAS_DISPLAY = "JAAS file location";
  ...
  private static final void addDatabaseOptions(ConfigDef config) {
    ...
    config.define(
        ...
        CONNECTION_KERBEROS_CONFIG,
        Type.STRING,
        null,
        Importance.LOW,
        CONNECTION_KERBEROS_DOC,
        DATABASE_GROUP,
        ++orderInGroup,
        Width.SHORT,
        CONNECTION_KERBEROS_DISPLAY
     ).define(
        CONNECTION_JAAS_CONFIG,
        Type.STRING,
        null,
        Importance.LOW,
        CONNECTION_JAAS_DOC,
